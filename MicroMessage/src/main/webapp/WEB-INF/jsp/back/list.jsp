	...
	<body style="background: #e1e9eb;">
		<form action="List.action" id="mainForm" method="post">
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="alink.action?page=insert">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:deleteBatch()">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
								<td width="90" align="right">指令：</td>
								<td>
									<input type="text" class="allInput" value="" name="commod"/>
								</td>
								<td width="90" align="right">描述：</td>
								<td>
									<input type="text" class="allInput" value="" name="descript"/>
								</td>
								...
								<c:forEach var="item" items="${requestScope.mesgList}" varStatus="status">
									<c:choose>
										...
										<td>
											...
											<a href="javascript:deleteOne(${item.id})">删除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
