		...
		<div id="outer">
			...
			<div id="inner_navig" class="div_b">
				<ul class="inner_navig">
					<li class="inner_navig"  id="li_5"><a href="${pageScope.path}/content/student/showStuInfo.jsp">个人信息展示</a></li>
					<li class="inner_navig"  id="li_6"><a href="${pageScope.path}/content/student/updateStuInfo.jsp">个人信息修改</a></li>
					<li class="inner_navig"  id="li_7"><a href="${pageScope.path}/content/student/mod_pwd.jsp">密码修改</a></li>
				</ul>
			</div>
			<div id="show_info">
				<form action="${pageScope.path}/ModPwdServlet" method="post">
					<table >
						<tr>
							<td>原密码：</td>
						...
						<tr>
							...
							&nbsp;&nbsp;<span style="color:red" id="mesg">${requestScope.mesg }</span></td>
						</tr>
					</table>
				</form>
			</div>
