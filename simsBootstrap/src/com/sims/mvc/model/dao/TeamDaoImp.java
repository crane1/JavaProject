...
public class TeamDaoImp{
	...
	public List<Student> findStudentByTeam(String classid) {
		...
		String sql=null;
		sql="select s.s_id,s.s_name,s.s_sex,s.s_age,s.s_gradfrom,s.s_tel,s.s_addr,s.s_idcard,s.s_email,s.s_team from sims_student s where s.s_team is null and s.s_class='"+classid+"'";
	...
	public int updateTeam(String teamId,String id){
		String sql=null;
		sql="update sims_student  set s_team='"+teamId+"' where s_id='"+id+"'";
