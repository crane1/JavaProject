...
public class StudentFindDAOImp implements IStudentFindDAO {
	...
	private List<Student> getQueryPage(String attrStr, String conditionStr,
		...
		list = (List<Student>) jt.execute(new CallableStatementCreator() {
			...
			public List<Student> doInCallableStatement(CallableStatement cs)
	...
	public void testDao() {
		...
		IStudentFindDAO stuDAo = (IStudentFindDAO) ac
				.getBean("studentFindDAOImp");
