...
<html>
	...
	<head>
		...
		<script src="${pageScope.path}/js/notmanagerteacher.js"></script>
		...
		<div id="outer">
			...
			<div id="inner_navig" class="div_b">
				<ul class="inner_navig">
					...
					<li class="inner_navig"  id="li_6"><a class="btn btn-primary" href="${pageScope.path}/content/classManger/NotManagerTacher.jsp" onclick="">查询未分班学员</a></li>
					<li class="inner_navig"  id="li_6"><a class="btn btn-primary" href="${pageScope.path}/content/classManger/classManager.jsp">任命班长</a></li>
					<li class="inner_navig"  id="li_6"><a class="btn btn-primary" href="#" onclick="chext()">添加学员</a></li>
				</ul>
			</div>
