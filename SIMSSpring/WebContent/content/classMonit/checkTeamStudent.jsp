...
<head>
		...
		<script src="${pageScope.path}/js/main.js"></script>
		<script src="${pageScope.path}/js/teamStudent.js"></script>
		...
		<div id="show_info">
            <div id="info" align="center">
			    <table>
					<tr>
					    <td>请输入你要查询组的ID</td>
					    <td><input type="text" id="teamId" placeholder="请输入组ID" ></td>
					</tr>
					<tr><td colspan="2"><button id="add" onclick="return showTeamStudent()">查询</button></td></tr>
