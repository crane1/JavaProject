...
<head>
		...
		<script src="${pageScope.path}/js/appointTeamLeader.js"></script>
		    ...
		    <div id="info" align="center">
				<table>
					...
					<tr>
						...
						<td>新组长ID</td>
						<td><input type="text" name="leaderId" id="leaderId"
							placeholder="请输入新组长ID"></td>
					</tr>
					<tr>
					<td colspan="2"><button id="add" onclick="appointTeamLeader()">添加</button></td>
				</tr>
				</table> 
			 </div>
		</div>
